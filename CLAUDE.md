...
## Estrutura do site
Home: topo (nome, frase concreta, links, idioma, tema) → projetos (lista com link para cada artigo) → trajetória → stack agrupada por área → "agora" → contato sem formulário.
