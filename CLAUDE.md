...
## Estrutura do site
Home: topo (nome, frase concreta, links, idioma, tema) → stack agrupada por área → projetos (lista com link para cada artigo) → trajetória → "agora" → contato sem formulário. Ordem pensada para recrutadores.
